local module = {
	...
	--// Tween information (recommended to only adjust the time (first number))
	["Tween Information"] = {
	...
	["CheckTime"] = 3, --// The time in seconds that the script checks for Period changes, if AutomaticTransitions is set to false, you don't need to worry about this
